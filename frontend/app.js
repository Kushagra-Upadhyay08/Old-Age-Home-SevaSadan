document.addEventListener('DOMContentLoaded', () => {
  ...
  if (userRole === 'admin') {
    document.getElementById('nav-servant-section')?.classList.add('hidden');
  }
      ...
      <div style="max-width:900px;">
        <form id="admission-form" novalidate>
          ...
          <div class="form-card">
            ...
            <div class="form-row-3">
              <div class="form-group"><label><span class="display-lang-en">Admission Date</span><span class="display-lang-gu" style="display:none;">દાખલ કરવાની તારીખ</span></label><input type="text" name="office_admission_date" class="text-input" readonly placeholder="Assigned upon approval"></div>
              <div class="form-group"><label><span class="display-lang-en">Monthly Charge (₹)</span><span class="display-lang-gu" style="display:none;">મંજૂર માસિક ચાર્જ (રૂ.)</span></label><input type="text" name="office_monthly_charge" class="text-input" readonly placeholder="TBD by Director"></div>
              <div class="form-group"><label><span class="display-lang-en">Director Signature</span><span class="display-lang-gu" style="display:none;">નિયામકની સહી</span></label><input type="text" name="office_director_signature" class="text-input" readonly placeholder="Pending Signature"></div>
            </div>
          </div>
  ...
  function showFormDetailModal(item) {
    ...
    const fields = [
      ...
      { l: 'Director Signature / સહી', v: item.office_director_signature || 'Pending' },
